...
# Global average pooling, input the obtained image features into a 1*1 convolution
# with 256 channels, and finally bilinearly upsample the features to a specific
# dimension (that is, the dimension of the feature map before inputting to ImagePool)
...
# ASPP module, improved by DeepLabV3, adds 1*1 convolution and global image pooling.
...
# The complete structure of DeepLabV3, using ResNet with
# atrous convolution + multi-grid strategy + improved ASPP
class DeepLabV3(nn.Sequential):
    ...
    def __init__(self, n_classes, n_blocks, atrous_rates, multi_grids, output_stride):
        ...
        # Connect the final features of all branches, input them into a 1*1 convolution of 256 channels,
        # add BN, and then enter the final 1*1 convolution to get the logits result.
    def forward(self, x):
